...
2. Click **Grading** in the navigation pane and complete the following fields:
   ...
   .. image:: /img/guides/assessment_LLM_free_auto.png
      :alt: Grading screen for LLM Free text auto-grade
   ...
   - Click the **Generate Rubrics**  button to initiate the process.
