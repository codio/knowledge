...
Assessments can be auto-generated from text found on a guides page. To auto-generate a Free Text assessment, select Free Text assessment from Assessments list and simply press the **Generate** button present at bottom right corner and press **Create** button to create the assessment.
