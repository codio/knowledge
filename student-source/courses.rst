...
You can create your own projects using the web-based IDE in Codio. To access the project area, use the BUILD links in the top navigation pane. See :ref:`Projects <projects>` for more information.
